    ...
    , start_drag(QPoint(0,0))
{
    ...
    TitleButton *btn = new TitleButton(0, false, tr("Genel"));
    ...
    btn = new TitleButton(2, false, tr("Ses"));
    connect(btn, SIGNAL(clicked(int)), this, SLOT(onButtonClicked(int)));
    layout->addWidget(btn);
    m_buttonList << btn;
    ...
    btn = new TitleButton(3, false, tr("Performans"));
    connect(btn, SIGNAL(clicked(int)), this, SLOT(onButtonClicked(int)));
    layout->addWidget(btn);
    m_buttonList << btn;
    ...
    btn = new TitleButton(4, false, tr("Altyazılar"));
    connect(btn, SIGNAL(clicked(int)), this, SLOT(onButtonClicked(int)));
    layout->addWidget(btn);
    m_buttonList << btn;
    ...
    btn = new TitleButton(5, false, tr("Ekran Resmi"));
    connect(btn, SIGNAL(clicked(int)), this, SLOT(onButtonClicked(int)));
    layout->addWidget(btn);
    m_buttonList << btn;
    ...
    btn = new TitleButton(6, false, tr("Kısayol Tuşu"));
    connect(btn, SIGNAL(clicked(int)), this, SLOT(onButtonClicked(int)));
    layout->addWidget(btn);
    m_buttonList << btn;
...
void PreferencesDialog::retranslateStrings() {
    ...
    okButton->setText(tr("Tamam"));
    cancelButton->setText(tr("İptal"));
    applyButton->setText(tr("Uygula"));
}
