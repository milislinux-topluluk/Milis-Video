...
//	intro_label->setText("<html><head/><body><p align=\"left\"><span style=\"font-size:14pt; font-weight:600;\">" + tr("Haydaa, bir hata oluştu") +"</span></p></body></html>");
...
void ErrorDialog::toggleLog(bool checked) {
    ...
    if (checked) {
		viewlog_button->setText(tr("Günlüğü Gizle"));
        this->setFixedSize(514, 364);
    }
    else {
		viewlog_button->setText(tr("Günlüğü Göster"));
        this->setFixedSize(514, 160);
    }
}
