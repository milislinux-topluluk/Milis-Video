...
void PrefScreenShot::createHelp() {
	...
	setWhatsThis(use_screenshots_check, tr("Ekran resmini etkinleştir"),
		tr("You can use this option to enable or disable the possibility to "
           "take screenshots.") );

	setWhatsThis(screenshot_edit, tr("Ekran resmi klasörü"),
		tr("Here you can specify a folder where the screenshots taken by "
           "Milis Video will be stored. If the folder is not valid the "
           "screenshot feature will be disabled.") );

    setWhatsThis(screenshot_template_edit, tr("Ekran resmi için şablon"),
    ...
    setWhatsThis(screenshot_format_combo, tr("Ekran resmi için biçim"),
