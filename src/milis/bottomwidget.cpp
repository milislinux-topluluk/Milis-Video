...
//    btPlayList->setShortcut(QKeySequence("F3"));
    ...
    btStop->setToolTip(tr("Dur"));
    btPrev->setToolTip(tr("Geri"));
    btPlayPause->setToolTip(tr("Oynat / Bekle"));
    btNext->setToolTip(tr("İleri"));
    btSound->setToolTip(tr("Sessiz"));
    btPlayList->setToolTip(tr("Oynatma Listesi"));
