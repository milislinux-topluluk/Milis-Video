...
ShortcutsWidget::ShortcutsWidget(QWidget *parent) : QWidget(parent)
{
    ...
    this->setWindowTitle(tr("Milis Video - Kısayollar"));
    timer = NULL;
    parent_widget = 0;
    title_label = NULL;
...
{
    forward_10s_title->setText(tr("%1 ileri").arg(Helper::timeForJumps(pref->seeking1)));
    forward_1m_title->setText(tr("%1 ileri").arg(Helper::timeForJumps(pref->seeking2)));
    forward_10m_title->setText(tr("%1 ileri").arg(Helper::timeForJumps(pref->seeking3)));

    back_10s_title->setText(tr("%1 ileri").arg(Helper::timeForJumps(pref->seeking1)));
    back_1m_title->setText(tr("%1 ileri").arg(Helper::timeForJumps(pref->seeking2)));
    back_10m_title->setText(tr("%1 ileri").arg(Helper::timeForJumps(pref->seeking3)));
}
...
void ShortcutsWidget::init_ui()
{
    ...
    title_label->setText(tr("Milis Video - Kısayollar"));
    ...
    control_title_label->setText(tr("Oynatma kontrolü"));
    ...
    other_title_label->setText(tr("Diğer kontrol"));
...
//    control_form_layout->setSizeConstraint(QLayout::SetFixedSize);//frame will fixed with content's width
    ...
    play_title->setText(tr("Oynat/Bekle"));
...
//    control_form_layout->addRow(tr("Oynat/Bekle"), play_label);

    play_pre_title = new QLabel();
    play_pre_title->setText(tr("Önceki"));
...
//    control_label_list.append(play_pre_label);
    ...
    play_next_title->setText(tr("Sonraki"));
...
//    control_label_list.append(vol_down_label);
    ...
    set_audio_delay_title->setText(tr("Ses gecikmesini ayarla"));
...
//    control_label_list.append(set_audio_delay_label);
    ...
    audio_delay_title->setText(tr("Ses gecikmesini artırma veya azaltma"));
...
//    control_label_list.append(audio_delay_label);
    ...
    playlist_title->setText(tr("Oynatma Listesi"));
    ...
    open_title->setText(tr("Dosya Aç"));
...
//    other_label_list.append(open_label);
    ...
    screenshot_title->setText(tr("Ekran Resmi"));
...
//    other_label_list.append(screenshot_label);
    ...
    pref_title->setText(tr("Seçenekler"));
...
//    other_label_list.append(pref_label);
    ...
    info_title->setText(tr("Bilgileri ve Özellikleri Görüntüle..."));
...
//    other_label_list.append(info_label);
    ...
    about_title->setText(tr("Hakkında"));
    ...
    fullscreen_title->setText(tr("Tam Ekran Aç/Kapat"));
