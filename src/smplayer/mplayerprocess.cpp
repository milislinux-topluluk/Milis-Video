...
//        qDebug("AAAA %s", line);
		...
		// Parse other things
//        qDebug("========MplayerProcess::parseLine: '%s'", line.toUtf8().data() );//'*** screenshot '/home/lixiang/鍥剧墖/milis_video_screenshots/shot0006.png' ***'
...
//            qDebug("MplayerProcess::parseLine: screenshot: '%s'", shot.toUtf8().data());//'/home/lixiang/鍥剧墖/milis_video_screenshots/shot0006.png'
