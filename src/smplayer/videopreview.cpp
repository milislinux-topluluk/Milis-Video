...
VideoPreview::VideoPreview(QString mplayer_path, QObject * parent) : QObject(parent)
{
    ...
    output_dir = "milis_video_preview";
...
//    qDebug() << "1111111111 dir=" << output_dir + "/" + framePicture();//1111111111 dir= "milis_video_preview/00000001.jpg"
//    qDebug() << "2222222222 dir=" << output_file;//2222222222 dir= "milis_video_preview/picture_00006068.jpg"
...
//    qDebug("VideoPreview::runMplayer: command: %s", command.toUtf8().constData());///usr/bin/mplayer -nosound -nocache -noframedrop -vo jpeg:outdir="/tmp/milis_video_preview" -frames 1 -ss 77 -aspect 1.7778 -zoom /home/lixiang/resources/1080.wmv
    //VideoPreview::runMplayer: command: /usr/bin/mplayer -nosound -nocache -noframedrop -vo jpeg:outdir="/tmp/milis_video_preview" -frames 1 -ss 470 -aspect 1.33333 -zoom /home/lixiang/resources/Katy Perry Roar.swf
	QProcess p;
