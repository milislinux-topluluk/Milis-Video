...
//        qDebug("AAA:%s", line.toUtf8().data());//Screenshot: '/home/lixiang/图片/milis_video_screenshots/cap_血战钢j岭_00:23:25_01.jpg'
		// Parse other things
//        qDebug("MPVProcess::parseLine: 'kobe test:%s'", line.toUtf8().data());//'kobe test:Screenshot: '/home/lixiang/图片/milis_video_screenshots/mpv-shot0001.jpg''
